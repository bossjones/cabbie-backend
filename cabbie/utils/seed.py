...
if __name__ == '__main__' :
    ...
    # 1. 라운드키 테스트
    k = s.SeedRoundKey('\x00' * 16)

    test_rk  = '7E8C8F7C2CA237C7DB6C27FF4A68CAA7'.decode('hex')
    test_rk += 'A1019D2F419E0470C4B359AE0CE94542'.decode('hex')
    test_rk += '0F40D6A14E39C1DB08359685CB1F5F0C'.decode('hex')
    test_rk += 'A7BD84B6AEAEA46141077ED1A10AE9FE'.decode('hex')
    test_rk += 'D505CC7694737AE9926FAC50E566261B'.decode('hex')
    test_rk += '4A90B765B3A7C38E222E7E2FB921B1A2'.decode('hex')
    test_rk += 'E4FD0B4D9B8D884EDC8D1C63C4A67843'.decode('hex')
    test_rk += '5FF66A2131C0787850118971B055B298'.decode('hex')
    ...
    plan = '000102030405060708090A0B0C0D0E0F'.decode('hex')
    ciph = '5EBAC6E0054E166819AFF1CC6D346CDB'.decode('hex')

    # 2. 암호화 테스트
    enc = s.SeedEncrypt(plan, k)
    if enc == ciph :
        print '[2] OK'
    else :
        print '[2] ERROR'
    ...
    data = '18991391'
    data = data.ljust(16, '0')[0:16]
    
    enc = s.SeedEncrypt(data, k)
